...
"}\n"
"TrackFrame[hoverState=\"true\"] {\n"
"	background-color: rgb(76, 76, 76);\n"
"}\n"
"TrackFrame[pressedState=\"true\"] {\n"
"	background-color: rgb(46, 46, 46);\n"
"}\n"
"TrackFrame[selectedState=\"true\"] {\n"
"	background-color: rgb(0, 160, 245);\n"
"}\n"
"TrackFrame[selectedState=\"true\"][hoverState=\"true\"] {\n"
"	background-color: rgb(0, 170, 255);\n"
"}\n"
"Track"
                        "Frame[selectedState=\"true\"][pressedState=\"true\"]  {\n"
"	background-color: rgb(0, 140, 225);\n"
"}\n"
"TrackFrame[downloadedState=\"false\"]  {\n"
"	background-color: rgb(103, 103, 103);\n"
"}\n"
"TrackFrame[downloadedState=\"false\"][hoverState=\"true\"] {\n"
"	background-color: rgb(113, 113, 113);\n"
"}\n"
"TrackFrame[downloadedState=\"false\"][pressedState=\"true\"]  {\n"
"	background-color: rgb(83, 83, 83);\n"
"}\n"
"TrackFrame[downloadedState=\"false\"][selectedState=\"true\"]  {\n"
"	background-color: rgb(245, 75, 0);\n"
"}\n"
"TrackFrame[downloadedState=\"false\"][selectedState=\"true\"][hoverState=\"true\"] {\n"
"	background-color: rgb(255, 85, 0);\n"
"}\n"
"TrackFrame[downloadedState=\"false\"][selectedState=\"true\"][pressedState=\"true\"]  {\n"
"	background-color: rgb(225, 55, 0);\n"
"}\n"
"\n"
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/buttons/resources/white/settings.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.info_loading.setGeometry(QRect(0, 0, 48, 48))
        ...
        self.container_nextListScrollArea.setGeometry(QRect(0, 0, 482, 94))
        ...
        sizePolicy9.setHeightForWidth(self.container_left.sizePolicy().hasHeightForWidth())
        self.container_left.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHeightForWidth(self.container_volumeBar.sizePolicy().hasHeightForWidth())
        self.container_volumeBar.setSizePolicy(sizePolicy10)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/buttons/resources/white/volume.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_mute.setIcon(icon3)
        ...
        sizePolicy11.setHeightForWidth(self.container_middle.sizePolicy().hasHeightForWidth())
        self.container_middle.setSizePolicy(sizePolicy11)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/buttons/resources/white/download.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/buttons/resources/white/organize.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_organize.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/buttons/resources/white/reverse.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_previous.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/buttons/resources/white/play.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/buttons/resources/white/skip.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_skip.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/buttons/resources/white/shuffle.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_shuffle.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/buttons/resources/white/loop.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_loop.setIcon(icon10)
        ...
        sizePolicy9.setHeightForWidth(self.container_right.sizePolicy().hasHeightForWidth())
        self.container_right.setSizePolicy(sizePolicy9)
        ...
        self.horizontalLayout_10 = QHBoxLayout(self.page_settings)
        ...
        self.container_stackedWidget.addWidget(self.page_settings)
        ...
        self.container_playlistSelectorScrollArea.setGeometry(QRect(0, 0, 592, 298))
